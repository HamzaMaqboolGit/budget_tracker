...
import React, { useMemo, useState, PureComponent, useCallback } from 'react'
...
function History({ userSettings }: { userSettings: usersettings }) {
    ...
    const dataAvaliable = historyDataQuery.data && historyDataQuery.data.length > 0;
...
function TooltipRow({
    ...
    const formatteringFn = useCallback((value: number) => {
